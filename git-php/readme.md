...
This repository is a fork of the original project [czproject/git-php](https://github.com/czproject/git-php/). You can find the original project at the following address: [https://github.com/czproject/git-php](https://github.com/czproject/git-php).

This repository contains a repackaged version of the PHP package adapted using the HashSig algorithm. It's important to note that no changes have been made to the original source code in this repackaged version. This fork is created solely to ensure compatibility with the HashSig package algorithm.
